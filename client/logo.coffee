dom.DRAW_LOGO = -> 
  ...
  real_width = Math.max 284, opts.line_length
  ...
  SVG 
    ...
    G 
      ...
      CIRCLE       
        ...
        cy: "55"
        r: "4.25"
        style: if opts.transition then crossbrowserfy({transition: 'cx 1000ms'}, 'transition') 
